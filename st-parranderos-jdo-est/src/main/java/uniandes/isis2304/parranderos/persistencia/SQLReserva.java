...
public class SQLReserva {
	...
	public long adicionarReserva (PersistenceManager pm, long id, long idAlojamiento, long numeroReservaCol, Integer descuento, Integer personas, Integer precioTotal, 
			Date fechaCheckIn, Date fechaCheckOut,Date fechaConfirmacion, Integer cantPagos, long idCliente) 
	{
		Query q = pm.newQuery(SQL, "INSERT INTO " + pp.darTablaReserva () + "(id, idAlojamiento, descuento, numeroReservaCol, personas, precioTotal,fechaCheckIn,fechaCheckOut,fechaConfirmacion, cantPagos, idCliente) values (?, ?, ?, ?, ?,?, ?, ?, ?, ?)");
		q.setParameters(id, idAlojamiento, descuento, numeroReservaCol, personas, precioTotal,fechaCheckIn,fechaCheckOut,fechaConfirmacion, cantPagos, idCliente);
